package com.gamenative.fruitymatch.fruit_timer;
...
public class Fruit_LivesTimer {
    ...
    // Constructors
    //--------------------------------------------------------
    public Fruit_LivesTimer(Activity activity) {
        mActivity = activity;
    }
    //========================================================
    ...
    public void startTimer() {
        mLivesNum = Fruit_Preferences.PREF_LIVES.getInt(Fruit_Preferences.KEY_LIVES, MAX_LIVES);
        ...
        mEndTime = Fruit_Preferences.PREF_LIVES.getLong(Fruit_Preferences.KEY_END_TIME, 0);
    ...
    public void stopTimer() {
        ...
        // Save to preferences
        Fruit_Preferences.PREF_LIVES.putInt(Fruit_Preferences.KEY_LIVES, mLivesNum);
        Fruit_Preferences.PREF_LIVES.putLong(Fruit_Preferences.KEY_MILLIS_LEFT, mTimeLeftInMillis);
        Fruit_Preferences.PREF_LIVES.putLong(Fruit_Preferences.KEY_END_TIME, mEndTime);
    }
    ...
    private void updateLivesText() {
        ...
        if (mLivesNum == 0) {
            btnLives.setBackgroundResource(R.drawable.fruit_ui_lives_lock);
        } else {
            btnLives.setBackgroundResource(R.drawable.fruit_ui_lives);
            if (mLivesNum == MAX_LIVES) {
