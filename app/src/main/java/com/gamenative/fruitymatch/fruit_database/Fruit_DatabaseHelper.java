package com.gamenative.fruitymatch.fruit_database;
...
public class Fruit_DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static Fruit_DatabaseHelper INSTANCE;

    //--------------------------------------------------------
    // Constructors
    //--------------------------------------------------------
    private Fruit_DatabaseHelper(Context context) {
    ...
    // Static methods
    //--------------------------------------------------------
    public static Fruit_DatabaseHelper getInstance(Context context) {
        if (INSTANCE == null) {
            INSTANCE = new Fruit_DatabaseHelper(context);
        }
