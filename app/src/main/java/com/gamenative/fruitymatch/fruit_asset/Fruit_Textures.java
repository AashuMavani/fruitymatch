...
public class Fruit_Textures {
    ...
    public static void load(Texture2DManager textureManager, Context context) {
        Bitmap grid = ResourceUtils.getBitmap(context, R.drawable.fruit_sprite_sheet_grid);
        ...
        Bitmap cherry = ResourceUtils.getBitmap(context, R.drawable.fruit_sprite_sheet_cherry);
        ...
        Bitmap strawberry = ResourceUtils.getBitmap(context, R.drawable.fruit_sprite_sheet_strawberry);
        ...
        Bitmap lemon = ResourceUtils.getBitmap(context, R.drawable.fruit_sprite_sheet_lemon);
        ...
        Bitmap coconut = ResourceUtils.getBitmap(context, R.drawable.fruit_sprite_sheet_coconut);
        ...
        Bitmap banana = ResourceUtils.getBitmap(context, R.drawable.fruit_sprite_sheet_banana);
        ...
        ICE_CREAM = textureManager.loadTexture(R.drawable.fruit_sprite_ice_cream);

        Bitmap cookie = ResourceUtils.getBitmap(context, R.drawable.fruit_sprite_sheet_cookie);
        ...
        Bitmap cake = ResourceUtils.getBitmap(context, R.drawable.fruit_sprite_sheet_cake);
        ...
        Bitmap pie = ResourceUtils.getBitmap(context, R.drawable.fruit_sprite_sheet_pie);
        ...
        Bitmap candy = ResourceUtils.getBitmap(context, R.drawable.fruit_sprite_sheet_candy);
        ...
        Bitmap lock = ResourceUtils.getBitmap(context, R.drawable.fruit_sprite_sheet_lock);
        ...
        Bitmap ice01 = ResourceUtils.getBitmap(context, R.drawable.fruit_sprite_sheet_ice_01);
        ...
        Bitmap ice02 = ResourceUtils.getBitmap(context, R.drawable.fruit_sprite_sheet_ice_02);
        ...
        Bitmap sand01 = ResourceUtils.getBitmap(context, R.drawable.fruit_sprite_sheet_sand_01);
        ...
        Bitmap sand02 = ResourceUtils.getBitmap(context, R.drawable.fruit_sprite_sheet_sand_02);
        ...
        Bitmap honey = ResourceUtils.getBitmap(context, R.drawable.fruit_sprite_sheet_honey);
        ...
        Bitmap generator = ResourceUtils.getBitmap(context, R.drawable.fruit_sprite_sheet_generator);
        ...
        Bitmap shell = ResourceUtils.getBitmap(context, R.drawable.fruit_sprite_sheet_shell);
        ...
        STARFISH = textureManager.loadTexture(R.drawable.fruit_sprite_starfish);
        ARROW = textureManager.loadTexture(R.drawable.fruit_sprite_arrow);
        PIPE = textureManager.loadTexture(R.drawable.fruit_sprite_pipe);

        Bitmap score = ResourceUtils.getBitmap(context, R.drawable.fruit_sprite_sheet_score);
        ...
        TEXT_COMBO_NICE = textureManager.loadTexture(R.drawable.fruit_text_combo_nice);
        TEXT_COMBO_GREAT = textureManager.loadTexture(R.drawable.fruit_text_combo_great);
        TEXT_COMBO_WONDERFUL = textureManager.loadTexture(R.drawable.fruit_text_combo_wonderful);
        TEXT_SHUFFLE = textureManager.loadTexture(R.drawable.fruit_text_shuffle);
        TEXT_BONUS = textureManager.loadTexture(R.drawable.fruit_text_bonus);

        TUTORIAL_FINGER = textureManager.loadTexture(R.drawable.fruit_sprite_tutorial_finger);

        Bitmap booster = ResourceUtils.getBitmap(context, R.drawable.fruit_sprite_sheet_booster);
        ...
        Bitmap confetti = ResourceUtils.getBitmap(context, R.drawable.fruit_sprite_sheet_confetti);
        ...
        LIGHT_BG = textureManager.loadTexture(R.drawable.fruit_sprite_light_bg);
        LIGHT_BG_BLUE = textureManager.loadTexture(R.drawable.fruit_sprite_light_bg_blue);
        LIGHT_RING = textureManager.loadTexture(R.drawable.fruit_sprite_light_ring);
        LIGHT_CIRCLE = textureManager.loadTexture(R.drawable.fruit_sprite_light_circle);
        GLITTER = textureManager.loadTexture(R.drawable.fruit_sprite_glitter);
        GLITTER_BLUE = textureManager.loadTexture(R.drawable.fruit_sprite_glitter_blue);
        FLASH_RING = textureManager.loadTexture(R.drawable.fruit_sprite_flash_ring);
        FLASH_RING_BLUE = textureManager.loadTexture(R.drawable.fruit_sprite_flash_ring_blue);
        FLASH_BEAM = textureManager.loadTexture(R.drawable.fruit_sprite_flash_beam);

        FLASH_ROW_ANIMATION = textureManager.loadTextureGroup(BitmapUtils.createRadiateBitmapRegions(
                ResourceUtils.getBitmap(context, R.drawable.fruit_sprite_flash_row), 10, BitmapUtils.BitmapRadiate.LEFT_TO_RIGHT));
        FLASH_COLUMN_ANIMATION = textureManager.loadTextureGroup(BitmapUtils.createRadiateBitmapRegions(
                ResourceUtils.getBitmap(context, R.drawable.fruit_sprite_flash_column), 10, BitmapUtils.BitmapRadiate.TOP_TO_DOWN));
        FLASH_EXPLOSION_ANIMATION = textureManager.loadTextureGroup(BitmapUtils.createRadiateBitmapRegions(
                ResourceUtils.getBitmap(context, R.drawable.fruit_sprite_flash_explosion), 10, BitmapUtils.BitmapRadiate.IN_TO_OUT));
        FLASH_TRANSFORM_ANIMATION = textureManager.loadTextureGroup(BitmapUtils.createRadiateBitmapRegions(
                ResourceUtils.getBitmap(context, R.drawable.fruit_sprite_flash_transform), 10, BitmapUtils.BitmapRadiate.IN_TO_OUT));

        Bitmap lightning = ResourceUtils.getBitmap(context, R.drawable.fruit_sprite_sheet_lightning);
        ...
        Bitmap smoke = ResourceUtils.getBitmap(context, R.drawable.fruit_sprite_sheet_smoke);
