...
public class Fruit_LightningGlitterEffect extends Sprite {

    private static final long TIME_TO_LIVE = 600;
    private static final long TIME_TO_FADE = 200;

    private final Fruit_LightningGlitterEffectSystem mParent;
    ...
    // Constructors
    //--------------------------------------------------------
    public Fruit_LightningGlitterEffect(Fruit_LightningGlitterEffectSystem lightningGlitterEffectSystem, Engine engine, Texture texture) {
