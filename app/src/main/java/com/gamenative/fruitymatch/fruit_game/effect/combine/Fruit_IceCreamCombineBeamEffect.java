...
public class Fruit_IceCreamCombineBeamEffect extends Sprite {

    private static final long TIME_TO_LIVE = 200;

    private final Fruit_IceCreamCombineBeamEffectSystem mParent;
    ...
    // Constructors
    //--------------------------------------------------------
    public Fruit_IceCreamCombineBeamEffect(Fruit_IceCreamCombineBeamEffectSystem iceCreamCombineBeamEffectSystem, Engine engine, Texture texture) {
    ...
    // Methods
    //--------------------------------------------------------
    public void activate(float x, float y, Fruit_FlashDirection direction) {
