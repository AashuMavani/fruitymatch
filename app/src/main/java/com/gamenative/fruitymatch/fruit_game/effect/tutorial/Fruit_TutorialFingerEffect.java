...
public class Fruit_TutorialFingerEffect extends Sprite implements TouchEventListener, Modifier.ModifierListener {
    ...
    // Constructors
    //--------------------------------------------------------
    public Fruit_TutorialFingerEffect(Engine engine, Texture texture) {
