...
public class Fruit_RowStripedGenerator extends Fruit_Generator {
    ...
    // Constructors
    //--------------------------------------------------------
    public Fruit_RowStripedGenerator(Engine engine, Texture texture) {
    ...
    // Inner Classes
    //--------------------------------------------------------
    private class RowStripedGeneratorResetter implements Fruit_TileResetter {
