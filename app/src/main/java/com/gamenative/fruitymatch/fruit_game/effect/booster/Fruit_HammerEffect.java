package com.gamenative.fruitymatch.fruit_game.effect.booster;
...
public class Fruit_HammerEffect extends Sprite {
    ...
    // Constructors
    //--------------------------------------------------------
    public Fruit_HammerEffect(Engine engine, Texture texture) {
