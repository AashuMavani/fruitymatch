...
public class Fruit_HoneyPieceEffect extends Sprite {
    ...
    // Constructors
    //--------------------------------------------------------
    public Fruit_HoneyPieceEffect(Engine engine, Texture texture, Fruit_HoneyPiece honeyPiece) {
    ...
    // Getter and Setter
    //--------------------------------------------------------
    public Fruit_HoneyPiece getHoneyPiece() {
        return mHoneyPiece;
    }
    //========================================================
