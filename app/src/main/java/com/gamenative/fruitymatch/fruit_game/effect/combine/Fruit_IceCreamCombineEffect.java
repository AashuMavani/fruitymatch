...
public class Fruit_IceCreamCombineEffect extends Sprite {
    ...
    private final Fruit_IceCreamCombineEffectSystem mParent;
    ...
    // Constructors
    //--------------------------------------------------------
    public Fruit_IceCreamCombineEffect(Fruit_IceCreamCombineEffectSystem iceCreamCombineEffectSystem, Engine engine, Texture texture) {
    ...
    public enum ColorCombineDirection {
        ...
        public int getLayer() {
            switch (this) {
                case LEFT:
                    return Fruit_GameLayer.EFFECT_LAYER;
                case RIGHT:
                    return Fruit_GameLayer.EFFECT_LAYER + 1;
            }
