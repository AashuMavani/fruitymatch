...
public enum Fruit_SandType {
    ...
    public Texture getSingleLayerTexture() {
        switch (this) {
            case CENTER:
                return Fruit_Textures.SAND_CENTER_01;
            case TOP:
            case DOWN:
            case LEFT:
            case RIGHT:
                return Fruit_Textures.SAND_SIDE_01;
            case TOP_LEFT:
            case TOP_RIGHT:
            case DOWN_LEFT:
            case DOWN_RIGHT:
                return Fruit_Textures.SAND_CORNER_01;
            case TOP_MARGIN:
            case DOWN_MARGIN:
            case LEFT_MARGIN:
            case RIGHT_MARGIN:
                return Fruit_Textures.SAND_MARGIN_01;
            case VERTICAL:
            case HORIZONTAL:
                return Fruit_Textures.SAND_PIPE_01;
            case SOLE:
                return Fruit_Textures.SAND_SOLE_01;
            default:
    ...
    public Texture getDoubleLayerTexture() {
        switch (this) {
            case CENTER:
                return Fruit_Textures.SAND_CENTER_02;
            case TOP:
            case DOWN:
            case LEFT:
            case RIGHT:
                return Fruit_Textures.SAND_SIDE_02;
            case TOP_LEFT:
            case TOP_RIGHT:
            case DOWN_LEFT:
            case DOWN_RIGHT:
                return Fruit_Textures.SAND_CORNER_02;
            case TOP_MARGIN:
            case DOWN_MARGIN:
            case LEFT_MARGIN:
            case RIGHT_MARGIN:
                return Fruit_Textures.SAND_MARGIN_02;
            case VERTICAL:
            case HORIZONTAL:
                return Fruit_Textures.SAND_PIPE_02;
            case SOLE:
                return Fruit_Textures.SAND_SOLE_02;
            default:
