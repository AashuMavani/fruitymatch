...
public class Fruit_LightningEffect extends AnimateSprite implements AnimateSprite.AnimationListener {

    private static final long TIME_TO_ANIMATE = 200;
    private static final long TIME_TO_FADE = 400;

    private final Fruit_LightningEffectSystem mParent;
    private final FadeOutModifier mFadeOutModifier;

    //--------------------------------------------------------
    // Constructors
    //--------------------------------------------------------
    public Fruit_LightningEffect(Fruit_LightningEffectSystem lightningEffectSystem, Engine engine, Texture2DGroup textureGroup) {
