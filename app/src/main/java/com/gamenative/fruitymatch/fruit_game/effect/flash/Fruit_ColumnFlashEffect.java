...
public class Fruit_ColumnFlashEffect extends AnimateSprite {

    private static final long TIME_TO_ANIMATE = 300;
    private static final long TIME_TO_FADE = 300;

    private final Fruit_ColumnFlashEffectSystem mParent;
    ...
    // Constructors
    //--------------------------------------------------------
    public Fruit_ColumnFlashEffect(Fruit_ColumnFlashEffectSystem columnFlashEffectSystem, Engine engine, Texture2DGroup textureGroup) {
