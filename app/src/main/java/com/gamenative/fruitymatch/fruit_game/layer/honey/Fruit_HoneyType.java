...
public enum Fruit_HoneyType {
    ...
    public Texture getTexture() {
        switch (this) {
            case CENTER:
                return Fruit_Textures.HONEY_CENTER;
            case TOP:
            case DOWN:
            case LEFT:
            case RIGHT:
                return Fruit_Textures.HONEY_SIDE;
            case TOP_LEFT:
            case TOP_RIGHT:
            case DOWN_LEFT:
            case DOWN_RIGHT:
                return Fruit_Textures.HONEY_CORNER;
            case TOP_MARGIN:
            case DOWN_MARGIN:
            case LEFT_MARGIN:
            case RIGHT_MARGIN:
                return Fruit_Textures.HONEY_MARGIN;
            case VERTICAL:
            case HORIZONTAL:
                return Fruit_Textures.HONEY_PIPE;
            case SOLE:
                return Fruit_Textures.HONEY_SOLE;
            default:
