...
public enum Fruit_GridType {
    ...
    public Texture getTexture() {
        switch (this) {
            case CENTER:
                return Fruit_Textures.GRID_CENTER;
            case TOP:
            case DOWN:
            case LEFT:
            case RIGHT:
                return Fruit_Textures.GRID_SIDE;
            case TOP_LEFT:
            case TOP_RIGHT:
            case DOWN_LEFT:
            case DOWN_RIGHT:
                return Fruit_Textures.GRID_CORNER;
            case TOP_MARGIN:
            case DOWN_MARGIN:
            case LEFT_MARGIN:
            case RIGHT_MARGIN:
                return Fruit_Textures.GRID_MARGIN;
            case VERTICAL:
            case HORIZONTAL:
                return Fruit_Textures.GRID_PIPE;
            case SOLE:
                return Fruit_Textures.GRID_SOLE;
            default:
