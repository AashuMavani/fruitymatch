...
public class Fruit_UpgradeFruitEffect extends Sprite {

    private static final int TIME_TO_LIVE = 300;

    private final Fruit_UpgradeFruitEffectSystem mParent;
    ...
    // Constructors
    //--------------------------------------------------------
    public Fruit_UpgradeFruitEffect(Fruit_UpgradeFruitEffectSystem upgradeFruitEffectSystem, Engine engine, Texture texture) {
