...
public class Fruit_RowFlashEffect extends AnimateSprite {

    private static final long TIME_TO_ANIMATE = 300;
    private static final long TIME_TO_FADE = 300;

    private final Fruit_RowFlashEffectSystem mParent;
    ...
    // Constructors
    //--------------------------------------------------------
    public Fruit_RowFlashEffect(Fruit_RowFlashEffectSystem rowFlashEffectSystem, Engine engine, Texture2DGroup textureGroup) {
