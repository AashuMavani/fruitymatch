...
public class Fruit_TransformFlashEffect extends AnimateSprite {

    private static final long TIME_TO_LIVE = 500;
    private static final long TIME_TO_FADE = 200;

    private final Fruit_TransformFlashEffectSystem mParent;
    ...
    // Constructors
    //--------------------------------------------------------
    public Fruit_TransformFlashEffect(Fruit_TransformFlashEffectSystem transformFlashEffectSystem, Engine engine, Texture2DGroup textureGroup) {
