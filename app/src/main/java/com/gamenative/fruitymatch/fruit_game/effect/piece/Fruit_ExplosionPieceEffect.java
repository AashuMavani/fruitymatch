...
public class Fruit_ExplosionPieceEffect extends Sprite {

    private static final long TIME_TO_LIVE = 1000;
    private static final long TIME_TO_FADE = 300;

    private final Fruit_ExplosionPieceEffectSystem mParent;
    ...
    // Constructors
    //--------------------------------------------------------
    public Fruit_ExplosionPieceEffect(Fruit_ExplosionPieceEffectSystem explosionPieceEffectSystem, Engine engine, Texture texture) {
    ...
    private static class EffectShadow extends Sprite {
        ...
        private static final ColorFilter SHADOW_FILTER = new PorterDuffColorFilter(Fruit_Colors.BLACK_10, PorterDuff.Mode.SRC_IN);
        ...
        public EffectShadow(Engine engine, Texture texture) {
            ...
            setLayer(Fruit_GameLayer.EFFECT_LAYER - 1);
        }
        //========================================================
