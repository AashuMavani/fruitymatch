...
public enum Fruit_IceType {
    ...
    public Texture getSingleLayerTexture() {
        switch (this) {
            case CENTER:
                return Fruit_Textures.ICE_CENTER_01;
            case TOP:
            case DOWN:
            case LEFT:
            case RIGHT:
                return Fruit_Textures.ICE_SIDE_01;
            case TOP_LEFT:
            case TOP_RIGHT:
            case DOWN_LEFT:
            case DOWN_RIGHT:
                return Fruit_Textures.ICE_CORNER_01;
            case TOP_MARGIN:
            case DOWN_MARGIN:
            case LEFT_MARGIN:
            case RIGHT_MARGIN:
                return Fruit_Textures.ICE_MARGIN_01;
            case VERTICAL:
            case HORIZONTAL:
                return Fruit_Textures.ICE_PIPE_01;
            case SOLE:
                return Fruit_Textures.ICE_SOLE_01;
            default:
    ...
    public Texture getDoubleLayerTexture() {
        switch (this) {
            case CENTER:
                return Fruit_Textures.ICE_CENTER_02;
            case TOP:
            case DOWN:
            case LEFT:
            case RIGHT:
                return Fruit_Textures.ICE_SIDE_02;
            case TOP_LEFT:
            case TOP_RIGHT:
            case DOWN_LEFT:
            case DOWN_RIGHT:
                return Fruit_Textures.ICE_CORNER_02;
            case TOP_MARGIN:
            case DOWN_MARGIN:
            case LEFT_MARGIN:
            case RIGHT_MARGIN:
                return Fruit_Textures.ICE_MARGIN_02;
            case VERTICAL:
            case HORIZONTAL:
                return Fruit_Textures.ICE_PIPE_02;
            case SOLE:
                return Fruit_Textures.ICE_SOLE_02;
            default:
