...
public class Fruit_ExplosiveGenerator extends Fruit_Generator {
    ...
    // Constructors
    //--------------------------------------------------------
    public Fruit_ExplosiveGenerator(Engine engine, Texture texture) {
    ...
    // Inner Classes
    //--------------------------------------------------------
    private class ExplosionSpecialTileGeneratorResetter implements Fruit_TileResetter {
        ...
        public void resetTile(Fruit_Tile tile) {
            ...
            if (tile.getColumn() == mCol) {
                ...
                mCount++;
                if (mCount >= MAX_COUNT) {
                    tile.setSpecialType(Fruit_SpecialType.EXPLOSIVE);
                    playGeneratorEffect();
                    mCount = 0;
                }
            }
